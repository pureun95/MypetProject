...
<style>
    ...
    <div id="content">
		...
		<div class="board-write">
			...
			<input type="text" class="form-control board-title" onclick="this.value=''" placeholder="기존카테고리">
			<!-- 각자 본인의 게시판에 들어가면 option이 selected 되어있도록?! 해보고싶어서 넣어봤어요. -->
	        <input type="text" class="form-control board-title" onclick="this.value=''" placeholder="기존제목">	        	
	        <textarea class="form-control board-content" onclick="this.value=''" placeholder="기존내용"></textarea> 	    	                      		           		        
	        ...
	        <div class="board-btn">
	        	...
	        	<input type="button" class="btn common-btn ok" value="수정">		        		        	      
	        </div>
