...
font-family: 'Jal_Onuel';
    ...
    <div id="content">
    	...
    	<div class="btn-group">
    		<input type="button" class="btn common-btn" onclick="location.href='/mypet/board/noticeList.action';" value="목록">
    		<input type="button" class="btn common-btn" value="수정">
        	<input type="button" class="btn common-btn act-del" data-toggle="modal" data-target="#act_delete" value="삭제">
    	</div>
        ...
        <table class="table table-condensed">
        	...
        	<c:if test="${ndto.image != null}">
	        	<tr class="headtr" style="border-bottom:none;">
	        		<td class="firsttd" colspan="10" style="padding: 30px 50px; border-bottom:1px solid transparent;">
	       				<div class="imgbox">       					
							<img class="image" src="/mypet/resources/images/notice${ndto.image}" alt="noticeimg">
	       				</div>
	        		</td>
	        	</tr>
        	 </c:if> 
 ...
 -->
        	...
        	<tr class="headtr">
        		...
        		<td class="firsttd" colspan="9"><a href="/mypet/board/noticeView.action?seqNotice=${ndto.seqNotice-1}">이전글로 가기</a></td>
        		</c:if>
        		<c:if test="${ndto.seqNotice==1}">
        	...
        	<tr class="headtr">
        		...
        		<td class="firsttd" colspan="9" style="border-bottom: 1px solid #e8e8e8"><a href="/mypet/board/noticeView.action?seqNotice=${ndto.seqNotice+1}">다음글로 가기</a></td>
        		</c:if>
        		<c:if test="${ndto.lseq==ndto.seqNotice}">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
         		${ndto.title} 를 삭제 하시겠습니까?
       
     	   </div>
            <div class="modal-footer">
              <button type="button" class="btn spon_modalbtn_save paycheck" onclick="location.href='/mypet/board/noticeList.action';" >삭제</button>
