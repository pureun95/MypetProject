...
<div id="content">
	<div class="board-title">보호소 찾아보기</div>
	
		<div class="well">
			<form method="GET" action="/mypet/shelter/more.action">
				<input type="text" name="query" class="form-control" required placeholder="보호소 이름을 입력해주세요.">
			</form>
		</div>
